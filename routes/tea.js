...
.put(isLoggedIn, isAuthor, upload.array('image'), validateTea, catchAsync(tea.update))
.delete(isLoggedIn, isAuthor, catchAsync(tea.delete))

router.get('/:id/edit', isLoggedIn, isAuthor, validateTea, catchAsync(tea.editForm))
